...
var close = [];
var open = [];
var c = document.getElementById("AStarLayer");
var lineDraw = document.getElementById("AStarGrid");
...
function setStartAS(){
	...
	console.log(r[startY].cells[startX].isStart);
	console.log(startX);
	console.log(startY);
	updatePaint();
}
